...
alarm_world = [
    {'name': 'alarm_world_%s' % i['name'],
     ...
     'divide': False,
     'if_change': True,
     'alarms': [{"bit": s, "text": str(a['name']) + " - " + str(i['name']), "type": a['type']} for s, a in
...
oee = [
    {"start": 5831, 'name': 'Машина 1', "end": 5832, "status": [
    ...
    {"start": 5836, 'name': 'Машина 2', "end": 5837, "status": [
        {"value": 7, 'type': 2, "text": "авария", "factor": 7},
        {"value": 6, 'type': 2, "text": "авария", "factor": 7},
        {"value": 4, 'type': 2, "text": "авария", "factor": 7},
        {"value": 0, 'type': 0, "text": "простой", "factor": 24},
    ...
    {"start": 5842, 'name': 'Машина 3', "end": 5843, "status": [
        {"value": 7, 'type': 2, "text": "авария", "factor": 7},
        {"value": 6, 'type': 2, "text": "авария", "factor": 7},
        {"value": 4, 'type': 2, "text": "авария", "factor": 7},
        {"value": 0, 'type': 0, "text": "простой", "factor": 24},
    ...
    {"start": 5848, 'name': 'Машина 4', "end": 5849, "status": [
        {"value": 7, 'type': 2, "text": "авария", "factor": 7},
        {"value": 6, 'type': 2, "text": "авария", "factor": 7},
        {"value": 4, 'type': 2, "text": "авария", "factor": 7},
        {"value": 0, 'type': 0, "text": "простой", "factor": 24},
